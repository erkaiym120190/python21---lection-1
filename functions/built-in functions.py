# "==============Build-in functions=================" # встроенные функии
...
# "map" # фунция, которая принимает первым аргументом функцию, вторым итерируемый обьект. 
# # map возвращает генератор, в котором все элементы - результат принимаемой функции, 
# # в которую мы передали элемент из последовательности
# # map возвращает либо True,  либо False
...
# "filter" # функция, которая возвращает генератор, принимает функцию и итерируемый обьект. 
# # результат будет последовательность из елементов итерируемого обьекта, которые прошли фильтр 
# # (проверку)
...
# "enumerate" # функция, которая принимает последовательность. возвращает генератор, 
# в котором каждый элемент - tuple состоящий из числа и элемента из последовательности
